Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "License.txt", "Manifest.txt", "README.txt", "Rakefile", "lib/days_and_times.rb", "lib/days_and_times/duration.rb", "lib/days_and_times/numeric.rb", "lib/days_and_times/object.rb", "lib/days_and_times/time.rb", "spec/days_and_times_spec.rb", "spec/spec_helper.rb"]
  s.has_rdoc = true
